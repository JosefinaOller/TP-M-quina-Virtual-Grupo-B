...
GENERATE: PUSH BP
          ...
          MOV ECX, [BP+2] ; cant sectores = 8
          MUL ECX, 512 ; cant bytes
          DIV ECX, 4 ; cant celdas
			;  ECX = (8*512)/4 = 1024
          MOV EDX, BUFFER  ;EDX = 0
          
          LDH %7FFF
          LDL %FFFF
          MOV EBX, AC  ; EBX = %7FFFFFFF = 2147483647

WHILE_G:  CMP ECX, EDX  ;1024 - 0(incremental)
          JNP END_G
          RND EBX	; AC = RND ENTRE 0 y 214748347(EBX)
          MOV [EDX], AC ; [0 hasta 1024 del DS] = RND
          ADD EDX, 1
          JMP WHILE_G
