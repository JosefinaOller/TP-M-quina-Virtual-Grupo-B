...
void imprimeEstadoRegistros(int[],OperandosYFlags);
...
void disassembler(Memoria*,OperandosYFlags,int);
...
void setDisco(int , Memoria *,char []);
//void setDisco(int, Memoria*);
void decodificaOperando(Memoria*,int,OperandosYFlags*,int);
